    ...
    return (
        <Navbar fluid rounded class="bg-[#1363DF] border-gray-200 dark:bg-gray-900 py-2 md:px-[50px] px-3">
            ...
            <div className="flex md:order-2 items-center justify-center space-x-3 md:space-x-0 rtl:space-x-reverse">
                <a href='#verifyCard'  class="text-[#1363DF] no-underline bg-white hover:bg-[#f5f5f5] rounded-lg text-sm px-7 py-4 text-center dark:bg-blue-600 dark:text-white dark:hover:bg-blue-700 dark:focus:ring-blue-800">Verify Card</a>
