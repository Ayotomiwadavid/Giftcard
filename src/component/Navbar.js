    ...
    return (
        <Navbar fluid rounded class="bg-[#1363DF] border-gray-200 dark:bg-gray-900 py-2 md:px-[50px] px-3">
            ...
            <div className="flex md:order-2 items-center justify-center space-x-3 md:space-x-0 rtl:space-x-reverse">
                <Button  class="text-[#1363DF] bg-white hover:bg-[#f5f5f5] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:text-white dark:hover:bg-blue-700 dark:focus:ring-blue-800">Verify Card</Button>
            ...
            <Navbar.Collapse className='bg-[#1363DF] mt-2'>
                <Navbar.Link href="#" class="block py-2 px-3 md:p-0 text-white rounded md:hover:bg-transparent hover:bg-white transition-all duration-700 md:hover:text-[#f5f5f5] hover:text-[#1363DF] md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                    Home
                </Navbar.Link>
