            ...
            <div class="py-5 lg:py-16 md:px-4 px-2 mx-auto">
                ...
                <form action="#" class="space-y-5 w-full items-center justify-center flex flex-col">
                    <div className='w-full flex flex-col items-center justify-center'>
                        ...
                        <select id="cardSelect" class="bg-gray-50 h-[55px] w-[95%] md:w-[65%] border border-gray-300 text-[#0B212F] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div className='w-full flex flex-col items-center justify-center'>
                        ...
                        <select id="countries" class="bg-gray-50 h-[55px] w-[95%] md:w-[65%] border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="sm:col-span-2 w-full flex flex-col items-center justify-center">
                        <label for="message" class=" w-[95%] md:w-[75%] items-center justify-start md:px-20 block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Redemption Code</label>
                        <input type='number' id="message" class="block p-2.5 h-[55px] w-[95%] md:w-[65%] text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Redemption Code"></input>
                    </div>
